...
<html>
<head>
	<title>Fashion ON | <?php echo "string"; ?> </title>
		...
		<section class="product-list">
			<div class="container">	
				...
				<div class="row">
					<?php
						error_reporting(1);
						$getPro = "SELECT * from products where gender = 'female' and status = 'sale ' AND category_id = ".$cate_id." LIMIT 8";
							...
							<div class="product-info">
								...
								<div class="buy-detail">
									<button type="button" class="btn btn-primary">
										<a href="forFemale.php?action=add&id=<?php echo $row['id'];?>">
		...
		<section class="product-list">
			<div class="container">	
				...
				<div class="row">
					<?php
						error_reporting(1);
						$getPro = "SELECT * from products where gender = 'female' and status = 'sell well' LIMIT 8";
						$resPro = $db-> fetchSql($getPro);
						foreach ($resPro as $key => $row) {
					?>
					<div class="col-md-3 col-sm-6 col-xs-12 product-item">
		...
		<section class="product-list">
			<div class="container">	
				...
				<div class="row">
					<?php
						error_reporting(1);
						$getPro = "SELECT * from products where gender = 'female' and status = 'hot ' LIMIT 8";
						$resPro = $db-> fetchSql($getPro);
						foreach ($resPro as $key => $row) {
					?>
					<div class="col-md-3 col-sm-6 col-xs-12 product-item">

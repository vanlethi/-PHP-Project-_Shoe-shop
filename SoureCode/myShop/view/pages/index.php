	...
	<main>
		<section class="product-list">
			<div class="container">	
				...
				<div class="row">
					<?php
						$saleSql = "SELECT * FROM products WHERE status = 'sale' LIMIT 8";
						...
						<div class="product-box">
							...
							<div class="product-info">
								...
								<div class="buy-detail">
									<a type="button" class="btn btn-primary" href="index.php?action=add&id=<?php echo $row['id'];?>">
		...
		<section class="product-list">
			<div class="container">	
				...
				<div class="row">
					<?php
						$saleSql = "SELECT * FROM products WHERE status = 'sell well' LIMIT 8";
						$saleResult = $db-> fetchSql($saleSql);
						foreach ($saleResult as $key => $row) {
					?>
					<div class="col-md-3 col-sm-6 col-xs-12 product-item">
